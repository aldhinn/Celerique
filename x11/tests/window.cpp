...
File: ./x11/tests/window.cpp
Author: Aldhinn Espinas
Description: This tests the wrapper for x11 API window.
...
int main(int argc, char** argv) {
    celeriqueLogInfo("Started CeleriqueEngineX11PluginTesting execution.");
    ...
    ::std::unique_ptr<::celerique::WindowBase> ptrWindow = ::celerique::x11::createWindow(
        900, 600, "CeleriqueEngineX11PluginTesting"
    );
    ...
    celeriqueLogInfo("Ending CeleriqueEngineX11PluginTesting execution.");
